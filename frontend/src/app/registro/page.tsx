      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg border border-gray-100">
        ...
        <form className="mt-8 space-y-4" onSubmit={handleRegister}>
          ...
          <div className="space-y-3">
            <div>
              <label htmlFor="full-name" className="block text-xs font-bold text-gray-700 uppercase mb-1">Nombre Completo</label>
              <input
                id="full-name"
                type="text"
                required
            ...
            <div>
              <label htmlFor="password"  className="block text-xs font-bold text-gray-700 uppercase mb-1">Nueva Contraseña</label>
              <input
                id="password"
                type="password"
                required
