    ...
    <nav className="bg-dr-blue text-white shadow-md sticky top-0 z-50 border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link href="/admin/usuarios" className="text-xs font-bold hover:text-blue-300 tracking-widest transition-colors uppercase">Usuarios</Link>
      ...
      <div className={`md:hidden bg-blue-900 overflow-hidden transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'max-h-64 border-t border-blue-800' : 'max-h-0'}`}>
        <div className="px-4 py-4 space-y-3">
          ...
          <Link href="/admin/publicidad" className="text-sm font-bold tracking-widest uppercase py-2">Publicidad</Link>
          <Link href="/admin/usuarios" className="text-sm font-bold tracking-widest uppercase py-2">Usuarios</Link>
          <Link href="/admin/configuracion" className="text-sm font-bold tracking-widest uppercase py-2 border-b border-blue-800 pb-2">Configuración</Link>
